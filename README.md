...
settings to meet your server's environment. Especially, pay attention to the first line (path of perl) and $validreferrer variable of `swrc.cgi`. You may also have to set up `.htaccess` file of something like
